const AllNigrianLG = {
    abia: [
        { value: 'aba north', label: 'Abia North' },
        { value: 'aba south', label: 'Abia South' },
    ...
    bayelsa: [
        ...
        { value: 'eketekema', label: 'Eketekema' },
    ...
    delta: [
        ...
        { value: 'biafra-north', label: 'Biafra-North' },
        { value: 'biafra-south', label: 'Biafra-South' },
        { value: 'burutu', label: 'Burutu' },
        { value: 'ethiope east', label: 'Ethiope East' },
        { value: 'ethiope west', label: 'Ethiope West' },
        { value: 'iaradial', label: 'Iaradial' },
        { value: 'iaradial-north', label: 'Iaradial-North' },
        { value: 'ilesha', label: 'Ilesha' },
        { value: 'ilesha-north', label: 'Ilesha-North' },
        ...
        { value: 'oko', label: 'Oko' },
        { value: 'oko-north', label: 'Oko-North' },
        { value: 'oko-south', label: 'Oko-South' },
        { value: 'olomu', label: 'Olomu' },
        { value: 'olomu-north', label: 'Olomu-North' },
        { value: 'omu', label: 'Omu' },
        { value: 'omu-north', label: 'Omu-North' },
        { value: 'patani', label: 'Patani' },
        { value: 'patani-north', label: 'Patani-North' },
        { value: 'udege', label: 'Udege' },
        { value: 'udege-north', label: 'Udege-North' },
    ...
    edo: [
        ...
        { value: 'esan northeast', label: 'Esan Northeast' },
        { value: 'esan southeast', label: 'Esan Southeast' },
        ...
        { value: 'igorha east', label: 'Igorha East' },
        { value: 'igorha west', label: 'Igorha West' },
        { value: 'ovia northeast', label: 'Ovia Northeast' },
        { value: 'ovia southwest', label: 'Ovia Southwest' },
    ...
    ekiti: [
        ...
        { value: 'oke-emesa', label: 'Oke-Emesa' },
        { value: 'oye', label: 'Oye' }
    ],
    enugu: [
        ...
        { value: 'isikwuato', label: 'Isikwuato' },
    ...
    kogi: [
        ...
        { value: 'deko', label: 'Dekina' },
        { value: 'yagba', label: 'Yagba' },
    ...
    ogun: [
        ...
        { value: 'agbado-north', label: 'Agbado North' },
        { value: 'agbado-south', label: 'Agbado South' },
        ...
        { value: 'imowo-ijebu', label: 'Imowo-Ijebu' },
        ...
        { value: 'ijebu-remo', label: 'Remo North' },
    ...
    osun: [
        { value: 'atesin', label: 'Atakunmosa East' },
        { value: 'awo', label: 'Atakunmosa West' },
    ...
    oyo: [
        ...
        { value: 'surulere-oyo', label: 'Surulere' }
    ],
    plateau: [
    ...
    rivers: [
        ...
        { value: 'ogba-east-edoni', label: 'Ogba/Egbema/Ndoni' },
    ...
    sokoto: [
        ...
        { value: 'illesha-baruba', label: 'Illela' },
...
export function getStateName(stateName) {
    return AllNigrianLG[stateName] || [];
}

export default AllNigrianLG;
