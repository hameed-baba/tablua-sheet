    ...
    >
      ...
      <div class="">
        <div class="form-group mt-0">
          ...
          <vee-form-field
            type="text"
            v-model="sessionToUpdate.session_name"
            name="session_name"
            :class="['form-input', errors.session_name ? 'is-invalid' : '']"
            placeholder="Enter session name (e.g., A, B, C)"
          />
      ...
      <div class="form-row mt-3">
        <div class="form-group">
          ...
          <vee-form-field
            type="date"
            v-model="sessionToUpdate.first_term_start"
        ...
        <div class="form-group">
          ...
          <vee-form-field
            type="date"
            v-model="sessionToUpdate.first_term_end"
            name="first_term_end"
      ...
      <div class="form-row mt-3">
        <div class="form-group">
          ...
          <vee-form-field
            type="date"
            v-model="sessionToUpdate.second_term_start"
        ...
        <div class="form-group">
          ...
          <vee-form-field
            type="date"
            v-model="sessionToUpdate.second_term_end"
      ...
      <div class="form-row mt-3">
        <div class="form-group">
          ...
          <vee-form-field
            type="date"
            v-model="sessionToUpdate.third_term_start"
        ...
        <div class="form-group">
          ...
          <vee-form-field
            type="date"
            v-model="sessionToUpdate.third_term_end"
            name="third_term_end"
...
const handleSubmit = async () => {
  ...
  apiServices
    .updateSession(props.sessionToUpdate.id, props.sessionToUpdate)
    .then((response) => {
      if (response.status == 200) {
        toggleUpdateModal();
        toast.success(
          "Session Update Successfully",
          `The session ${props.sessionToUpdate.session_name} has been updated successfully.`
        );
