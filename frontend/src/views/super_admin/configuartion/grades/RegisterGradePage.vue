      ...
      >
        ...
        <div class="summary-card">
          ...
          <div class="summary-content">
            <div class="summary-item">
              ...
              <span class="summary-value">{{ formData.grade_name }}</span>
            </div>
            <div class="summary-item">
              <span class="summary-label">Grade Type:</span>
              <span class="summary-value">
                {{
                  formData.grade_type === "letter_grade"
                    ? "Letter Grade"
                    : "Remark Grade"
                }}
              </span>
        ...
        <div class="form-card">
          ...
          <div class="ranges-container">
            <div
              v-for="(range, index) in formData.gradeSystems"
              :key="index"
            ...
            >
              <div class="range-header">
                ...
                <button
                  ...
                  v-if="formData.gradeSystems.length > 1"
                >
        ...
        <div class="form-actions pe-4">
          ...
          <button type="submit" class="btn btn-success" :disabled="loading">
            ...
            {{ loading ? "Saving..." : "Register Grade System" }}
          </button>
        </div>
      </vee-form>
    </div>
...
const addGradeRange = () => {
  formData.value.gradeSystems.push({
    from_mark: "",
    to_mark: "",
    grade: "",
    remark: "",
...
const removeGradeRange = (index) => {
  formData.value.gradeSystems.splice(index, 1);
};
...
const handleSubmit = async () => {
  ...
  apiServices
    .createGrade(formData.value)
    .then((response) => {
      if (response.status == 201) {
        toast.success(
          "Grade System Created Successfully",
          `The grade system ${formData.value.grade_name.trim()} has been created successfully.`
        );
        router.push("/configuration");
      }
    })
    .catch((error) => {
      ...
      toast.error(
        "Failed to Create Grade System",
        error.response?.data?.message ||
          "An error occurred while creating the grade system. Please try again."
      );
    })
    .finally(() => {
      loading.value = false;
