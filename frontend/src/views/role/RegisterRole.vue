  ...
  <div class="page">
    <div class="page-header mb-1">
      <div>
        ...
        <p>Define role permissions and access levels</p>
      </div>
    ...
    <div class="data-table-container p-5">
      <form @submit.prevent="createRole">
        ...
        <!-- Permissions Section -->
        <div class="form-group">
          <div class="permissions-header mb-0">
    ...
    .then((response) => {
      if (response.status === 201) {
        ...
        toast.success(
          ...
          `The role "${form.role_name.trim()}" has been created successfully.`
        );
...
<style scoped>
/* Reuse your existing UpdateRole CSS — it fits perfectly */
