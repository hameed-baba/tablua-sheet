<template>
  <BaseModal :show="showModal" title="Add New Class" @close="toggleModal">
    <vee-form
    ...
    >
      <div class="form-row mt-0">
        ...
        <div class="form-group">
          ...
          <vee-form-field
            as="select"
            v-model="formData.grade_list_id"
            name="grade_list_id"
      ...
      <div class="form-row mt-3">
        <div class="form-group">
          ...
          <vee-form-field
            ...
            @update:modelValue="getStaffBySection"
...
const handleSubmit = async () => {
  ...
  apiServices
    .createClass(formData.value)
    .then((response) => {
      if (response.status == 201) {
        toggleModal();
        toast.success(
          "Class Created Successfully",
          `The class for ${formData.value.class_name} has been created successfully.`
        );
